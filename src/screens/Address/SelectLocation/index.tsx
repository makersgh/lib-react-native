...
import { Box } from 'lib_components';
  ...
  return (
    <Box flex={1}>
      <MapView
        ...
        customMapStyle={colorScheme === 'dark' ? googleMapDarkModeStyles : undefined}
        zoomControlEnabled
      ...
      >
        {markerLocation && (
          <Marker draggable coordinate={markerLocation} onDragEnd={onMarkerDragEd} />
        )}
      </MapView>
    </Box>
  );
